...
if (isset($_POST['register'])) {
  ...
  //   <a href='http://localhost/rama_htdocs/kelompok%202_19.2B.01/sidokot/components/activasi.php?t=".$password."'>http://localhost/tugassemester2/kelompok%202_19.2B.01/sidokot/activation.php?t=".$password."</a>  ";
